...
(function (global, factory) {
  ...
  */
  ...
  function printWarning(level, format, args) {
    ...
    {
      const hasExistingStack = args.length > 0 && typeof args[args.length - 1] === 'string' && args[args.length - 1].indexOf('\n    in') === 0;
  ...
  || typeof MessageChannel !== 'function') {
    ...
    if (typeof console !== 'undefined') {
      ...
      const { cancelAnimationFrame } = window; // TODO: Remove fb.me link
