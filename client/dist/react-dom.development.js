...
(function (global, factory) {
  ...
  const { unstable_cancelCallback } = _ReactInternals$Sched;
  const { unstable_now } = _ReactInternals$Sched;
  const { unstable_scheduleCallback } = _ReactInternals$Sched;
  const { unstable_shouldYield } = _ReactInternals$Sched;
  const { unstable_requestPaint } = _ReactInternals$Sched;
  const { unstable_getFirstCallbackNode } = _ReactInternals$Sched;
  const { unstable_runWithPriority } = _ReactInternals$Sched;
  const { unstable_next } = _ReactInternals$Sched;
  const { unstable_continueExecution } = _ReactInternals$Sched;
  const { unstable_pauseExecution } = _ReactInternals$Sched;
  const { unstable_getCurrentPriorityLevel } = _ReactInternals$Sched;
  const { unstable_ImmediatePriority } = _ReactInternals$Sched;
  const { unstable_UserBlockingPriority } = _ReactInternals$Sched;
  const { unstable_NormalPriority } = _ReactInternals$Sched;
  const { unstable_LowPriority } = _ReactInternals$Sched;
  const { unstable_IdlePriority } = _ReactInternals$Sched;
  const { unstable_forceFrameRate } = _ReactInternals$Sched;
  const { unstable_flushAllWithoutAsserting } = _ReactInternals$Sched;
  ...
  const { __interactionsRef } = _ReactInternals$Sched$1;
  const { __subscriberRef } = _ReactInternals$Sched$1;
  const { unstable_clear } = _ReactInternals$Sched$1;
  const { unstable_getCurrent } = _ReactInternals$Sched$1;
  const { unstable_getThreadID } = _ReactInternals$Sched$1;
  const { unstable_subscribe } = _ReactInternals$Sched$1;
  const { unstable_trace } = _ReactInternals$Sched$1;
  const { unstable_unsubscribe } = _ReactInternals$Sched$1;
  const { unstable_wrap } = _ReactInternals$Sched$1;
  ...
  const runWithPriority = unstable_runWithPriority; // TODO: can we stop exporting these?
  ...
  const Scheduler_scheduleCallback = unstable_scheduleCallback;
  const Scheduler_cancelCallback = unstable_cancelCallback;
  const Scheduler_shouldYield = unstable_shouldYield;
  const Scheduler_requestPaint = unstable_requestPaint;
  const Scheduler_now$1 = unstable_now;
  const Scheduler_getCurrentPriorityLevel = unstable_getCurrentPriorityLevel;
  const Scheduler_ImmediatePriority = unstable_ImmediatePriority;
  const Scheduler_UserBlockingPriority = unstable_UserBlockingPriority;
  const Scheduler_NormalPriority = unstable_NormalPriority;
  const Scheduler_LowPriority = unstable_LowPriority;
  const Scheduler_IdlePriority = unstable_IdlePriority;
